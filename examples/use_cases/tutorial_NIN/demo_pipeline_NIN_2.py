...
m_rig.resize(1,1,.2).play(fr = 30, gain = 5, magnification=1, offset = add_to_movie)
#%%
downs = .2
...
downs = .2
cm.concatenate([m_rig.resize(1,1,downs),m_els.resize(1,1,downs)],axis = 1).play(fr = 30, gain = 15,magnification=2, offset = add_to_movie) 
