...
for e in gt_names:
    ...
    spatial_filter_, time_trace_, of_or = caiman.behavior.extract_motor_components_OF(m, n_components, mask = mask, resize_fact= resize_fact, only_magnitude = only_magnitude, max_iter = 1000, verbose = True)
